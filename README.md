...
## Api сайта 
У нашего сайта также есть открытое api.  Можно достать большую часть информации о контенте, который находится на сайте. Для некоторых действий нужно быть авторизованным.
...
- Получить фильмы пользователя категории "Смотреть позже" (нужно быть авторизованным)
- Получить информацию из профиля пользователя (статус, никнейм, страна, дата рождения и т.д.)
- Оплатить подписку (нужно быть авторизованным)
- Получить фильм по id
- Добавить комментарий к фильму (нужно быть авторизованным)
- Получить фильмы, которые рекомендованы текущему пользователю (нужно быть авторизованным)
...
- **ASP Net Core 6** на C# с рендерингом страниц на стороне сервера;
