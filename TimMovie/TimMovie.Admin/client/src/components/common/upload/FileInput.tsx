...
export const FileInput: FC<FileInputProps> = ({setPreview, setFile, uploadProps}) => {
    ...
    function getDragContainer() {
        return (<p className={styles.text_drugAndDrop}>
            Давай даваааааай
        </p>)
    }

    function getNotDragContainer() {
        return (<>
            <div className="mb-4">
                ...
                <div>
                    <div className={drag ? styles.input_dragAndDrop : styles.input_dragAndDrop_dropped}
                        ...
                        <div className={styles.info_drugAndDrop_container}>
                            {drag ? getDragContainer() : getNotDragContainer()}
                        </div>
                        <div>
                            <input onChange={e => onLoadFromInputHandler(e)} ref={inputFile} type="file" multiple
                                   accept="image/*" hidden/>
                        </div>
                    </div>
                </div>
